...
| `ScanItem` | スキャン結果 1 件 | `ruleId: String`, `tier: Tier`, `title: String`, `bytes: Int64`（実割当サイズ合計）, `fileCount: Int`, `paths: [String]`, `state: ItemState`, `reason: String?`, `dataless: Bool`, `cacheHit: Bool` |
